...
using static OR.SisProductosEN.CompraEN;
...
namespace OR.SisProductos.Controllers
{
    public class CompraController : Controller
    {
        ...
        {
            ViewBag.Proveedores = new SelectList(await proveedorBL.ObtenerTodoAsync(), "Id", "Nombre");
        ...
        public async Task<ActionResult> Create(CompraEN compra)
        {
            try
            {
